    ...
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur shadow">
      <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-3">
        <span
          ...
          className="flex items-center gap-2 text-blue-600 font-bold text-2xl tracking-tight select-none"
        >
        ...
        <nav className="flex items-center space-x-5 text-base font-medium">
          ...
          <button className="hover:text-blue-600 transition" onClick={() => window.scrollTo({top: document.getElementById("how-it-works")?.offsetTop || 0, behavior: "smooth"})}>How It Works</button>
          <button className="hover:text-blue-600 transition" onClick={() => window.scrollTo({top: document.getElementById("why-choose")?.offsetTop || 0, behavior: "smooth"})}>Why Choose Us</button>
          <button className="hover:text-blue-600 transition" onClick={() => window.scrollTo({top: document.getElementById("partners")?.offsetTop || 0, behavior: "smooth"})}>Partners</button>
          <button className="hover:text-blue-600 transition" onClick={() => window.scrollTo({top: document.getElementById("resources")?.offsetTop || 0, behavior: "smooth"})}>Resources</button>
